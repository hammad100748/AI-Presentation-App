...
interface ShareAdBottomSheetProps {
  visible: boolean;
  onClose: () => void;
  onWatchAd: () => void;
  onCancel: () => void;
...
const ShareAdBottomSheet: React.FC<ShareAdBottomSheetProps> = ({
  visible,
  onClose,
  onWatchAd,
  onCancel,
      ...
      <View style={styles.modalOverlay}>
        <View style={styles.modalContent}>
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.headerTitle}>Share Presentation</Text>
          ...
          <ScrollView
            ...
            <View style={styles.content}>
              <View style={styles.iconContainer}>
                <Ionicons name="share-outline" size={adjust(48)} color="#4F67ED" />
              </View>

              <Text style={styles.title}>Watch an Ad to Share</Text>
              <Text style={styles.subtitle}>
                Watch a short ad to share your presentation for free
              </Text>

              <View style={styles.benefitsList}>
                <View style={styles.benefitItem}>
                  <Ionicons name="checkmark-circle" size={adjust(20)} color="#4F67ED" />
                  <Text style={styles.benefitText}>Share your presentation</Text>
                </View>
                <View style={styles.benefitItem}>
                  <Ionicons name="checkmark-circle" size={adjust(20)} color="#4F67ED" />
          ...
          <View style={styles.buttonContainer}>
            ...
            <TouchableOpacity
              ...
              <Text style={styles.watchAdButtonText}>Watch Ad & Share</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
...
export default ShareAdBottomSheet; 